...
<body>
	<div style="position:absolute;background:url(images/icon2.png);background-repeat: no-repeat;margin-top: 35%;background-position: top-center; width: 250px;"></div>
	<!-- <img src="images/icon2.png" style="width: 250px; position: absolute;"> -->
	<div class="cont">
		...
		<div class="sub-cont">
			<div class="img">
				<div class="img-text m-up">
					...
					<img src="images/ICONBI.png" style="width: 230px;height: 170;z-index: 10;margin-top: 25px;">
				</div>
