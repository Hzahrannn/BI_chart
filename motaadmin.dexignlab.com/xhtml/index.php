							...
							<div class="col-xl-6 col-lg-12 col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">PROYEKSI MATA UANG</h4>
                                        <form action="index.php" method="post">
	                                        <select name="mt">
	                                        	<option <?php if($m === "100.000"){echo "selected";} ?>>100.000</option>
	                                        	<option <?php if($m === "50.000"){echo "selected";} ?>>50.000</option>
	                                        	<option <?php if($m === "20.000"){echo "selected";} ?>>20.000</option>
	                                        	<option <?php if($m === "10.000"){echo "selected";} ?>>10.000</option>
	                                        	<option <?php if($m === "2.000"){echo "selected";} ?>>2.000</option>
	                                        	<option <?php if($m === "1.000"){echo "selected";} ?>>1.000</option>
	                                        	<option <?php if($m === "500"){echo "selected";} ?>>500</option>
	                                        	<option <?php if($m === "200"){echo "selected";} ?>>200</option>
	                                        	<option <?php if($m === "100"){echo "selected";} ?>>100</option>
	                                        	<option <?php if($m === "50"){echo "selected";} ?>>50</option>
	                                        </select>
